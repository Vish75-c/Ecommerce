...
const CardDrawer = ({open,toggledrawer}) => {
  ...
  return (
    <div className={`fixed top-0 right-0 w-3/4 sm:w-1/2 md:w-auto h-full bg-white shadow-lg transform-all transition-transform duration-300 flex flex-col ${open?'translate-x-0':'translate-x-full'}`}>
      ...
      <div className='sticky bottom-0 p-4 flex  flex-col items-center'>
        <button className='bg-zinc-700 text-white rounded-lg w-full py-2 hover:bg-zinc-600 transition'>Checkout</button>
